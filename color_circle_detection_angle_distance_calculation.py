...
while True:
    ...
    if switch_value == 1: # start to detect circles
        ...
        elif circles2 is None or circles2[0,0,0] == 0:# if didn't find the moving circle by color mask, then use moving tracking coordinates
            circle2 = [[cX_old, cY_old, 1]]
