...
height, width = 160*3, 90*3
dim = (height, width)
training_gen = DataGenerator(training_data, training_label, dim=dim, batch_size=4, shuffle=True)
validation_gen = DataGenerator(training_data[:1000], training_label[:1000], dim=dim, batch_size=4, shuffle=True)
...
lossWeights = {"classifier_branch": 1.0, "coordinate_branch": 10.0}
