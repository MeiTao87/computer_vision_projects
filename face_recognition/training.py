...
S=3
dim = (48*3, 64*3)
training_path = '/home/mt/Desktop/For_github/computer_vision_projects/face_recognition'
...
def yolo_loss(y_true, y_pred):
    ...
    box_loss = 5 * box_mask * response_mask * K.square((label_xy - predict_xy) / dim[0]*dim[1])
    box_loss += 5 * box_mask * response_mask * K.square((K.sqrt(label_wh) - K.sqrt(predict_wh)) / dim[0]*dim[1])
